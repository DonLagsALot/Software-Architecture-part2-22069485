...
public final class ClinicianDialog extends JDialog {
    public final JTextField name = new JTextField(22);
    public final JTextField specialty = new JTextField(22);
    public final JTextField phone = new JTextField(22);

    private boolean ok = false;

    public ClinicianDialog(Window owner, String title) {
        super(owner, title, ModalityType.APPLICATION_MODAL);
        setLayout(new BorderLayout(10,10));

        JPanel form = new JPanel(new GridLayout(0,2,8,8));
        form.add(new JLabel("Name")); form.add(name);
        form.add(new JLabel("Specialty")); form.add(specialty);
